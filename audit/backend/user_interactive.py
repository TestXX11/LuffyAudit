                                ...
                                if choice2 >= 0 and choice2 < len(host_bind_list):
                                    ...
                                    cmd = "sshpass -p %s /usr/local/openssh/bin/ssh %s@%s -p %s -o StrictHostKeyChecking=no -Z %s" \
                                          % (selected_host.host_user.password, selected_host.host_user.username,
                                             selected_host.host.ip_addr, selected_host.host.port, ran_tag)
                                    print(cmd,'cmd...\n')
