                        ...
                        while True:
                            ...
                            if choice2.isdigit():
                                ...
                                if choice2 >=0 and choice2 < len(host_bind_list):
                                    ...
                                    print(selected_host.host_user.password) 
                                    print(selected_host.host_user.username) 
                                    print(selected_host.host.ip_addr) 
                                    print(selected_host.host.port)
                                    print(random_tag) 
                                    ...
                                    print(cmd)
                                    print(settings.SESSION_TRACKER_SCRIPT,random_tag,session_obj.id)
