"""
Django settings for jackupdownAudit project.
...
SECRET_KEY = 'r7&(%_jll99lqr9t8oi16%9v^11^n5ih$weo&a*rx3vo1t=0b&'
...
ROOT_URLCONF = 'jackupdownAudit.urls'
...
WSGI_APPLICATION = 'jackupdownAudit.wsgi.application'
